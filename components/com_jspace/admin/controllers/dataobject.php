...
class JSpaceControllerDataObject extends JControllerForm
{
	...
	public function setSchema()
	{
		...
		$app->setUserState('com_jspace.edit.dataobject.schema', $label);
		
		$app->setUserState('com_jspace.edit.dataobject.data', $data);
