CREATE TABLE IF NOT EXISTS `#__jspace_dataobjects` (
	...
	`language` char(7) NOT NULL COMMENT 'The language code for the data object.',
	...
	`schema` varchar(255) NOT NULL DEFAULT 'DataObject' COMMENT 'The schema to load as part of this data object.',
...
'{"hideFields":["asset_id","locked_by","locked_on","version"],"ignoreChanges":["modified_by", "modified_on", "locked_by", "locked_on", "version", "hits"],"convertToInt":["publish_up", "publish_down"],"displayLookup":[{"sourceColumn":"catid","targetTable":"#__categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"#__viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"} ]}');

INSERT INTO `#__jspace_dataobjects` (`title`, `alias`) VALUES ('JSPACE_ROOT_DATA_OBJECT', 'root');
