...
<ul class="nav nav-tabs nav-stacked">
	...
	<li>
		<a class="choose_schema" href="#" title="<?php echo JText::_($item->description); ?>"
			onclick="javascript:setRecordSchema('<?php echo base64_encode(json_encode(array('id'=>$this->recordId, 
'label'=>JText::_($item->label), 'name'=>$item->name, 'parent'=>$this->parentId))); ?>')">
