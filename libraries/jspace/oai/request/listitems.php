 ...
 * @subpackage  OAI
 */
class JSpaceOAIRequestListItems extends JSpaceOAIRequest
{
	/**
	 *
	 ...
	 * @var string
	 */
	protected $_xmlBodyTag = 'ListItems';
	...
	public function _setResponseBody() {
		$xmlBody = $this->_responseXml->addChild($this->_xmlBodyTag);
		$list = array();
		...
		$this->_setResponseBodyIn($xmlBody, $list);
		
		$this->_resumptionTokenParam->addResumptionToken( $xmlBody );
	}
