...
use JSpace\Archive\RecordHistory;

class JSpaceArchiveRecordTest extends \TestCaseDatabase
{
    ...
    public function testSaveRecordWithAssets()
    {
        ...
        $record = Record::getInstance($record->id);
    ...
    public function testGetTree()
    {
        ...
        $record = Record::getInstance($parent_id);

        $tree = Record::getTree($parent_id);
    ...
    public function testLazyLoading()
    {
        ...
        $record = JSpace\Archive\Record::getInstance($parent_id);
